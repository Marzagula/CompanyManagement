...
INSERT INTO fiscal_value (fiscal_year, fiscal_value_type, fiscal_value_subtype, limit_value, limit_condition, description)
VALUES
    ...
    (2024, 'TAX_DEDUCTION', 'tax_free_under26', 85528.0, NULL, 'Kwota wolna od podatku dla osób które nie ukończyły 26 lat'),
    (2024, 'TAX_DEDUCTION', 'employee_costs', 250.00, NULL, 'Koszt pracownika miesięcznie gdy pracuje w miejscu zamieszkania');
    (2024, 'TAX_DEDUCTION', 'employee_costs', 300.00, NULL, 'Koszt pracownika miesięcznie gdy nie pracuje w miejscu zamieszkania');
