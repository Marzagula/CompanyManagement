...
CREATE TABLE IF NOT EXISTs PAYMENT_RANGE (
    ID BIGSERIAL PRIMARY KEY,
...
-- Wstawianie danych do DEPARTMENT
...
-- Wstawianie danych do tabeli JOB
-- IT Department Jobs
...
-- Wstawianie zakresów płacowych do tabeli PAYMENT_RANGE
